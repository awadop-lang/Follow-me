...
<head>
    <meta charset="UTF-8">
    <title>TACTICAL_HUD // NOX_V6.4</title>
    <style>
        ...
        .card { background: rgba(255,255,255,0.01); border: 1px solid #1a1a1a; padding: 10px; margin-bottom: 8px; cursor: pointer; border-radius: 2px; }
        .card:hover { background: rgba(0,255,255,0.1); border-color: var(--p); transform: translateX(5px); }
        
        /* Inspector */
        .inspector { background: #000; border: 1px solid #222; border-top: 2px solid var(--p); display: flex; flex-direction: column; padding: 10px; }
        ...
        .watch-item { font-size: 11px; padding: 5px; border-bottom: 1px solid #111; display: flex; justify-content: space-between; }
...
<body>
    <header>
        <div style="font-size: 16px; font-weight: bold; letter-spacing: 4px; color: var(--p);">[ TACTICAL_MONITOR_V6.4 ]</div>
    ...
    <div class="grid">
        ...
        <div class="watchlist-panel">
            <div style="font-size:10px; color:#ff00ff; margin-bottom:5px;">// GLOBAL_WATCHLIST</div>
